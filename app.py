...
start_date1 = (datetime.datetime.now() - datetime.timedelta(days=3)).strftime('%Y-%m-%d')
interval1 = '1m'
...
def train_model(stocks_ticker, start_date, intereval):
    ...
    random_search = RandomizedSearchCV(estimator = model_rf, n_iter = 10, param_distributions = param_grid, n_jobs = -1, verbose = 2)
